            ...
            <div>
              ...
              <form className="space-y-5">
                <div>
                  ...
                  <input type="text" id="name" className="w-full bg-surface-dark-alt border border-border-dark rounded px-4 py-2.5 text-text-on-dark placeholder:text-text-muted-on-dark/50 focus:outline-none focus:border-gold transition-colors" placeholder={t("contact.form.name.ph")} />
                </div>
                <div>
                  <label htmlFor="email" className="block text-sm text-text-muted-on-dark mb-1">{t("contact.form.email")}</label>
                  <input type="email" id="email" className="w-full bg-surface-dark-alt border border-border-dark rounded px-4 py-2.5 text-text-on-dark placeholder:text-text-muted-on-dark/50 focus:outline-none focus:border-gold transition-colors" placeholder={t("contact.form.email.ph")} />
                </div>
                <div>
                  <label htmlFor="company" className="block text-sm text-text-muted-on-dark mb-1">{t("contact.form.company")}</label>
                  <input type="text" id="company" className="w-full bg-surface-dark-alt border border-border-dark rounded px-4 py-2.5 text-text-on-dark placeholder:text-text-muted-on-dark/50 focus:outline-none focus:border-gold transition-colors" placeholder={t("contact.form.company.ph")} />
                </div>
                <div>
                  <label htmlFor="message" className="block text-sm text-text-muted-on-dark mb-1">{t("contact.form.message")}</label>
                  <textarea id="message" rows={5} className="w-full bg-surface-dark-alt border border-border-dark rounded px-4 py-2.5 text-text-on-dark placeholder:text-text-muted-on-dark/50 focus:outline-none focus:border-gold transition-colors resize-none" placeholder={t("contact.form.message.ph")} />
                </div>
