      ...
      <section className="relative py-20 md:py-28 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[1, 2, 3].map((i) => {
              ...
              return (
                <div
                  key={i}
                  className="bg-surface/80 backdrop-blur-sm border border-border rounded-lg p-6 hover:border-gold/30 transition-colors group"
                >
                  ...
                  <h3 className="font-semibold text-lg mb-2">{t(`services.${i}.title`)}</h3>
                  <p className="text-sm text-foreground/50 leading-relaxed">{t(`services.${i}.desc`)}</p>
                </div>
              );
            })}
          </div>
          ...
          <div className="text-center mt-10">
            <Link href="/services" className="text-gold text-sm hover:text-gold-light transition-colors">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="flex gap-4">
                ...
                <div>
                  <h3 className="font-semibold mb-1">{t(`why.${i}.title`)}</h3>
                  <p className="text-sm text-foreground/50 leading-relaxed">{t(`why.${i}.desc`)}</p>
                </div>
              </div>
            ))}
          </div>
